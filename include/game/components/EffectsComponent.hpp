...
class Effect : public Sprite {
	public:
		Effect(const std::string &textureName, u16 frameWidth, u16 frameHeight, sf::Vector2f _offset = {0, 0})
...
class EffectsComponent {
	public:
		Effect &addEffect(const std::string &name, const std::string &textureName, u16 frameWidth, u16 frameHeight, sf::Vector2f offset = {0, 0}) {
